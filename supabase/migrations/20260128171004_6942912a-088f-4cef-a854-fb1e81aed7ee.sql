-- Teil 1 (entfernt): Der manuelle Insert eines Test-Users mit hartcodierter UUID
-- schlägt auf einem frischen Projekt fehl (FK auf auth.users) und wird nicht benötigt.
